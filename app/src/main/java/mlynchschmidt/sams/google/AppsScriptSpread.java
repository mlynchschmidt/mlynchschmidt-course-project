package mlynchschmidt.sams.google;

/**
 * Created by Morgan on 11/12/2015.
 */

//SPREADS APPS SCRIPT QUICK START SAMPLE
/* Apps Script is necessary to utilize the necessary spreads operations; which are not sufficiently supported with the spreads API.
Apps Script will execute javascript written through google to perform spreadsheet operations within the drive API.
 */
...
public class AppsScriptSpread extends Activity {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            AppsScriptSpread.REQUEST_AUTHORIZATION);
                } else {
